...
class Minifier {
    ...
    protected $merge_images = false;
    //Use google closure (utilizes cURL)
    protected $use_closure = true;
    ...
    public function __construct( $vars = array() )
    {
        ...
        log_message('debug', 'Minifier Class Initialized');

        empty($vars) OR $this->initialize($vars);
        
    } //end __construct()
   
	 public function initialize($vars)
    {

...
$billing_content = '<div class="report_area" style="font-size:12px; padding:0px; margin:0px auto; text-align:left; border:0px solid #ccc; width:'.$set_width[$printer_pin].'px;">';		
...
foreach($exp_text as $kline => $data_line){
			...
			if(!empty($dt_exp)){
				...
				if(str_repeat("-", $jml_dt_exp) == $dt_exp){
					...
					if(empty($separator_start_html)){
						...
						$separator_start_html .= '<div style="padding:0px 0px 2px 0px; border-top:1px solid #444; clear:both;"></div>';
					}
				...
				if(str_repeat("_", $jml_dt_exp) == $dt_exp){
					...
					if(empty($separator_start_html)){
						...
						$separator_start_html .= '<div style="padding:0px 0px 2px 0px; border-bottom:1px solid #444; clear:both;"></div>';
					}
	...
	$billing_content .= $exp_text[$kline];
}

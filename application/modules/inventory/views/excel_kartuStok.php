							...
							foreach($category_item_data[$key] as $dtItem){
								if(!empty($report_data[$dtItem])){
									...
									if(!empty($data['stock_trx'])){
										...
										<tr>
											<td class="tbl_data_td_first_xcenter"><?php echo "01-".date("m-Y"); ?></td>
											...
											<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($stok_akhir_hpp); ?></td>
											<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($stok_akhir_total); ?></td>
										</tr>
										...
										<tr>
											...
											<td class="tbl_summary_td_xright"><?php echo priceFormat($total_stok_masuk_hpp); ?></td>
											<td class="tbl_summary_td_xright"><?php echo priceFormat($total_stok_masuk); ?></td>
											<td class="tbl_summary_td_xcenter"><?php echo priceFormat($total_stok_keluar_qty); ?></td>
											<td class="tbl_summary_td_xright"><?php echo priceFormat($total_stok_keluar_hpp); ?></td>
											<td class="tbl_summary_td_xright"><?php echo priceFormat($total_stok_keluar); ?></td>
											<td class="tbl_summary_td_xcenter"><?php echo priceFormat($stok_akhir_qty); ?></td>
											<td class="tbl_summary_td_xright">Rp. <?php echo priceFormat($stok_akhir_hpp); ?></td>
											<td class="tbl_summary_td_xright">Rp. <?php echo priceFormat($stok_akhir_total); ?></td>
										</tr>
										<tr>

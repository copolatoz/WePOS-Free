		...
		<table width="<?php echo $set_width; ?>">
			...
			<thead>
				...
				<tr class="tbl-header">
					...
					<td class="xcenter" width="150">TOTAL PENGIRIMAN</td>
					<td class="xcenter" width="150">TOTAL BARANG</td>
					<td class="xcenter" width="150">TOTAL QTY</td>		
				</tr>
			</thead>
			<tbody>
				<?php
				if(!empty($report_data)){
					...
					<tr class="tbl-total">
						...
						<td class="xcenter xbold"><?php echo $total_dis; ?></td>

	...
	<table width="<?php echo $set_width; ?>">
		...
		<thead>
			...
			<tr>
				...
				<td class="tbl_head_td_xcenter" rowspan="2" width="80">KODE</td>
				<td class="tbl_head_td_xcenter" rowspan="2" width="250">NAMA BARANG</td>		
				<td class="tbl_head_td_xcenter" rowspan="2" width="100">SATUAN</td>			
				<?php 
				...
				?>			
				<td class="tbl_head_td_xcenter" rowspan="2" width="120">TOTAL<br/>QTY</td>			
				<td class="tbl_head_td_xcenter" rowspan="2" width="120">TOTAL<br/>HRG.BELI</td>
			</tr>
			<tr>
				<?php 
				for($i=1; $i<=$total_days; $i++){
				...
				if(!empty($category_data)){
					foreach($category_data as $key => $dt){
						...
						if(!empty($category_item_data[$key])){
							...
							foreach($category_item_data[$key] as $dtItem){
								...
								?>
									<tr>
										...
										<td class="tbl_data_td_xcenter"><?php echo $data['item_code']; ?></td>
										...
										for($i=1; $i<=$total_days; $i++){
											...
											?>
											<td class="tbl_data_td_xcenter"><?php echo priceFormat($tot_in); ?></td>												
											<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($hpp_in); ?></td>
											<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($total_in); ?></td>
											<?php 
										}
										...
										<td class="tbl_data_td_xcenter"><?php echo priceFormat($data['total_in']); ?></td>
										<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($total_item_price); ?></td>
									</tr>
									<?php
									$no++;
								}
							...
							?>
							<tr>
								<td class="tbl_summary_td_first_xright" colspan="3">TOTAL <?php echo $dt; ?> </td>
								...
								for($i=1; $i<=$total_days; $i++){
									...
									?>
									<td class="tbl_summary_td_xcenter"><?php echo priceFormat($cat_qty); ?></td>	
									<td class="tbl_summary_td_xright">&nbsp;</td>	
									<td class="tbl_summary_td_xright">Rp. <?php echo priceFormat($cat_total); ?></td>	
									<?php 
								}
								?>
								<td class="tbl_summary_td_xcenter"><?php echo priceFormat($cat_total_qty); ?></td>
								<td class="tbl_summary_td_xright">Rp. <?php echo priceFormat($cat_total_price); ?></td>
							</tr>
							<?php
						}
					}
					...
					?>
					<tr>
						<td class="tbl_summary_td_first_xright" colspan="3">TOTAL ALL CATEGORY </td>
						<td class="tbl_summary_td_xright">&nbsp;</td>	
						<?php
						$all_total_qty = 0;
						$all_total_price = 0;

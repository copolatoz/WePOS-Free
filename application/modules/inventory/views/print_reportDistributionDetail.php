		...
		<table width="<?php echo $set_width; ?>">
			...
			<thead>
				...
				<tr class="tbl-header">
					...
					<td class="xleft" width="200">DIKIRIM DARI</td>
					<td class="xleft" width="200">DIKIRIM KE</td>
					<td class="xlweft" width="130">DITERIMA OLEH</td>
					<td class="xcenter" width="90">DATE</td>		
					<td class="xcenter" width="100">DIS NO</td>			
			...
			<tbody>
				...
				if(!empty($report_data)){
					...
					?>
					<tr class="tbl-total">
						<td class="first xright xbold" colspan="8">TOTAL</td>

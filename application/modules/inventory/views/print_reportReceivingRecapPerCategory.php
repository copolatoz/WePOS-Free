	...
	<div class="report_area" style="width:<?php echo $set_width.'px'; ?>;">
		...
		<table width="<?php echo $set_width; ?>">
			...
			<thead>
				...
				<tr class="tbl-header">
					<td class="first xcenter" rowspan="2" width="350">CATEGORY NAME</td>	
					<?php 
			...
			<tbody>
				...
				if(!empty($report_data)){
					...
					if(!empty($category_data)){
							...
							if(!empty($category_item_data[$key])){
								...
								<tr class="tbl-data">
									...
									for($i=1; $i<=$total_days; $i++){
										...
										?>
										<td class="xcenter"><?php echo priceFormat($cat_qty); ?></td>	
										<td class="xright">&nbsp;</td>	
										<td class="xright"><?php echo priceFormat($cat_total); ?></td>	
										<?php 
									}
									?>
									<td class="xcenter"><?php echo priceFormat($cat_total_qty); ?></td>
									<td class="xright"><?php echo priceFormat($cat_total_price); ?></td>
								</tr>
								<?php
						...
						?>
						<tr class="tbl-total">
							<td class="first xright xbold">TOTAL </td>
							<?php
							$all_total_qty = 0;
							$all_total_price = 0;
							for($i=1; $i<=$total_days; $i++){

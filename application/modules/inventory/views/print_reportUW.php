		...
		<table width="<?php echo $set_width; ?>">
			...
			<thead>
				...
				<tr class="tbl-header">
					...
					<td class="xcenter" width="80">UW.NO</td>
				...
				if(!empty($report_data)){
					...
					foreach($report_data as $det){
						...
						<tr class="tbl-data">
							...
							<td class="xcenter"><?php echo $det['uw_date']; ?></td>
							<td class="xcenter"><?php echo $det['uw_number']; ?></td>
							<td class="xleft"><?php echo $det['uw_from_name']; ?></td>
							...
							<td class="xleft"><?php echo $det['uw_memo']; ?></td>

	...
	<table width="<?php echo $set_width; ?>">
		...
		<thead>
			...
			<tr>
				...
				<td class="tbl_head_td_xcenter" width="150">TOTAL PENGIRIMAN</td>
			...
			if(!empty($report_data)){
				...
				foreach($report_data as $det){
					...
					<tr>
						...
						<td class="tbl_data_td_xcenter"><?php echo $det['total_dis']; ?></td>
				...
				<tr>
					...
					<td class="tbl_summary_td_xcenter"><?php echo $total_dis; ?></td>

...
class KartuStokItem extends MY_Controller {
	...
	public function print_kartuStokItem(){
		...
		if(empty($item_id)){
			//$item_id = $this->stock->get_primary_storehouse();
			//$item_id = -1;
			die('Select Item');
		}
		...
		$useview = 'print_kartuStokItem';
		if($do == 'excel'){
			$useview = 'excel_kartuStokItem';
		}else{

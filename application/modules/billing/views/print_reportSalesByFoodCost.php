	...
	<div class="report_area" style="width:<?php echo $set_width.'px'; ?>;">
		...
		<table width="<?php echo $set_width; ?>">
			...
			<tr class="tbl-header">
				...
				<td class="xleft" width="130">SATUAN</td>
				<td class="xcenter" width="100">TOTAL QTY USED</td>
				<td class="xcenter" width="60">TOTAL ORDER</td>
				<td class="xcenter" width="60">AVERAGE QTY/ORDER</td>
			</tr>

	...
	<table width="<?php echo $set_width; ?>">
		...
		<tbody>
			...
			<tr>
				...
				<td class="tbl_head_td_xcenter" width="350">SALES</td>
				<?php
				if(!empty($total_day)){
			...
			if(!empty($report_data)){
						...
						if(!empty($total_day)){
							for($i=1; $i<=$total_day; $i++){
								...
								if(!empty($dtDet[$new_date])){
									...
									?>
									<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($dtDet[$new_date]['total_billing'],2,".",""); ?></td>
									<?php
								}else{
									?>
				...
				<tr>
					...
					if(!empty($total_billing_perday)){
						foreach($total_billing_perday as $dt){
							?>
							<td class="tbl_summary_td_xright">Rp. <?php echo priceFormat($dt,2,".",""); ?></td>
							<?php
						}
					}
					?>
				...
				<tr>
					...
					if(!empty($total_discount_peritem_perday)){
						foreach($total_discount_peritem_perday as $dt){
							?>
							<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($dt,2,".",""); ?></td>
							<?php
						}
					}
					?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">TOTAL SETELAH PB1</td>
					<?php
					...
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							...
							if(!empty($total_qty_billing[$new_date])){
								?>
								<td class="tbl_data_td_xright">Rp. <?php echo priceFormat(count($total_qty_billing[$new_date]),2,".",""); ?></td>
								<?php
							}else{
								?>
								<td class="tbl_data_td_xright">0</td>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">SETTLEMENT WEPOS</td>
							...
							if(!empty($total_day)){
								for($i=1; $i<=$total_day; $i++){
									...
									if(!empty($payment_perday[$payment_id][$new_date])){
										?>
										<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($payment_perday[$payment_id][$new_date],2,".",""); ?></td>
										<?php
									}else{
										?>
										<td class="tbl_data_td_xright">0</td>
					...
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							...
							if(!empty($total_payment_perday[$new_date])){
								?>
								<td class="tbl_summary_td_xright">Rp. <?php echo priceFormat($total_payment_perday[$new_date],2,".",""); ?></td>
								<?php
							}else{
								?>
				...
				<tr>
					...
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							...
							?>
							<td class="tbl_summary_td_xright">Rp. <?php echo priceFormat($selisih_perday,2,".",""); ?></td>
							<?php
						}
					}
					?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">PAYMENT</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							$add_mk = ($i-1) * ONE_DAY_UNIX;
							$new_date = date("d/m/Y", ($mk_date_from+$add_mk));
							?>
							<td class="tbl_data_td_xright" width="110">&nbsp;<?php echo $new_date; ?></td>
							<?php
						}
					}
					?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">KAS</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
							<td class="tbl_data_td_xright" width="110">&nbsp;</td>
							<?php
						}
					}
					?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">PIUTANG (AR)</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">DEBIT BCA</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">FLAZZ BCA</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">MAESTRO</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">CREDIT CARD</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>"> &nbsp; - BCA</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>"> &nbsp; - VISA BCA</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>"> &nbsp; - VISA BNI</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>"> &nbsp; - VISA CARD</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>"> &nbsp; - MASTERCARD BCA</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>"> &nbsp; - MASTERCARD BNI</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>"> &nbsp; - MASTERCARD</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">DEBIT BNI</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">VOUCHER</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_summary_td_first_xright" colspan="<?php echo 2; ?>">JUMLAH PEMBAYARAN</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
							<td class="tbl_summary_td_xright" width="110">&nbsp;</td>
							<?php
						}
					}
					?>
				...
				<tr>
					<td class="tbl_summary_td_first_xright" colspan="<?php echo 2; ?>">Selisih Settlement dan Payment</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">Administrasi Credit Card</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">Total Credit Card</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">Pendapatan Lain-Lain</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">Jumlah Setoran</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>
				...
				<tr>
					<td class="tbl_data_td_first" colspan="<?php echo 2; ?>">Tanggal Setor</td>
					<?php
					if(!empty($total_day)){
						for($i=1; $i<=$total_day; $i++){
							?>

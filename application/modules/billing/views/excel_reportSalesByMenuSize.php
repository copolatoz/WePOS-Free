	...
	<table width="<?php echo $set_width; ?>">
		...
		<thead>
			...
			<tr>
				...
				<td class="tbl_head_td_xcenter" width="260" rowspan="2">PRODUCT</td>
		...
		if(!empty($report_data)){
			...
			$compliment_total = 0;
			foreach($qty_terbanyak as $key => $dtDet){
				...
				?>
				<tr>
					<td class="tbl_summary_td_first_xright" colspan="<?php echo 3; ?>">TOTAL <?php echo $key; ?> </td>

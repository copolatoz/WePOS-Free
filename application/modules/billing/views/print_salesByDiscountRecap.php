		...
		<table width="<?php echo $set_width; ?>">
			...
			<thead>
				...
				<tr class="tbl-header">
					...
					<td class="xcenter" width="100" rowspan="2">QTY BILLING</td>
			...
			<tbody>
				...
				if(!empty($report_data) AND $discount_type != 'buyget'){
					...
					<tr class="tbl-total">
						...
						<td class="xcenter xbold"><?php echo $total_qty_billing; ?></td>
				...
				<tr class="tbl-header">
					<td class="first xcenter" width="50" rowspan="2">NO</td>
					<td class="xcenter" width="130" rowspan="2">BUY &amp; GET/PROMO</td>
					<td class="xcenter" width="100" rowspan="2">QTY BILLING</td>
					<td class="xcenter" width="100" rowspan="2">QTY MENU</td>
					<td class="xcenter" width="110" rowspan="2">TOTAL BILLING</td>
					<?php
				...
				if(!empty($buyget_data) AND ($discount_type == '' OR $discount_type == 'buyget')){
					...
					?>
					<tr class="tbl-data">
						<td class="first xcenter" colspan="<?php echo $total_cols; ?>">Data Buy & Get/Promo Not Found</td>
					</tr>
					<?php
				}
				?>

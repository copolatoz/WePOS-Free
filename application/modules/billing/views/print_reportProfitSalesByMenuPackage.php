			...
			if(!empty($report_data)){
				...
				foreach($qty_terbanyak as $key => $total){
					...
					<tr class="tbl-data">
						...
						<td class="xleft xbold" colspan="<?php echo $total_cols-1; ?>"><?php echo $package_name_show; ?></td>
					</tr>
					<?php
					...
					?>
					<tr class="tbl-data">
						<td class="first xright xbold" colspan="<?php echo $total_cols-4; ?>">TOTAL <?php echo $package_name_show; ?> </td>

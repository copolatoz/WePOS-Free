	...
	<table width="<?php echo $set_width; ?>">
		...
		if(!empty($report_data)){
			...
			foreach($report_data as $key => $dtDet){
				...
				$category_code_show = '0000';
				$category_name_show = 'n/a';
				if(empty($category_name[$key])){
					$category_name_show = 'Category Deleted';
				}else{
					$category_name_show = $category_name[$key];
				}
				
				if(!empty($category_code[$key])){
					$category_code_show = $category_code[$key];
				}
				...
				<tr>
					...
					<td class="tbl_head_td" colspan="<?php echo $total_cols-1; ?>"><?php echo $category_code_show.' / '.$category_name_show; ?></td>
				</tr>
				<?php
				$no = 1;
				...
				?>
				<tr>
					<td class="tbl_summary_td_first_xright" colspan="<?php echo 3; ?>">TOTAL <?php echo $category_code_show.' / '.$category_name_show; ?> </td>
			...
			?>
			<tr>
				<td class="tbl_summary_td_first_xright" colspan="<?php echo 3; ?>">TOTAL ALL CATEGORY </td>

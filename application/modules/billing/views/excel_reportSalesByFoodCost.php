	...
	<table width="<?php echo $set_width; ?>">
		...
		<thead>
			...
			<tr>
				...
				<td class="tbl_head_td" width="130">SATUAN</td>
				<td class="tbl_head_td_xcenter" width="100">TOTAL QTY USED</td>
				<td class="tbl_head_td_xcenter" width="60">TOTAL ORDER</td>
				<td class="tbl_head_td_xcenter" width="60">AVERAGE QTY/ORDER</td>
			</tr>
		</thead>
		<tbody>
		<?php
		if(!empty($report_data)){
			...
			foreach($report_data as $det){
				...
				<tr>
					...
					<td class="tbl_data_td"><?php echo $det['unit_name']; ?></td>

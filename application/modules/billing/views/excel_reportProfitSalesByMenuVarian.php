	...
	<table width="<?php echo $set_width; ?>">
		...
		if(!empty($report_data)){
				...
				foreach($qty_terbanyak as $key => $total){
					...
					$varian_name_show = 'n/a';
					if(empty($varian_name[$key])){
						$varian_name_show = 'NON VARIAN';
					}else{
						$varian_name_show = 'VARIAN: '.strtoupper($varian_name[$key]);
					}
				...
				<tr>
					...
					<td class="tbl_head_td" colspan="<?php echo $total_cols-1; ?>"><?php echo $varian_name_show; ?></td>
				</tr>
				<?php
				$no = 1;
					$cat_total_qty = 0;
				...
				?>
				<tr>
					<td class="tbl_summary_td_first_xright" colspan="<?php echo $total_cols-4; ?>">TOTAL <?php echo $varian_name_show; ?> </td>
			...
			?>
			<tr>
				<td class="tbl_summary_td_first_xright" colspan="<?php echo $total_cols-4; ?>">TOTAL</td>

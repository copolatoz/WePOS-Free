	...
	<table width="<?php echo $set_width; ?>">
		...
		<thead>
				...
				<td colspan="<?php echo $total_cols ?>">
					<div>
						...
						if(!empty($customer_name_report)){
							?>
							<div class="subtitle_report_xcenter">CUSTOMER: <?php echo $customer_name_report; ?></div>	
							<?php
						}
						?>
					</div>
			...
			<tr>
				...
				<td class="tbl_head_td" width="150" rowspan="2">CUSTOMER NAME</td>
				<td class="tbl_head_td" width="150" rowspan="2">CUSTOMER COMPANY</td>
			...
			if(!empty($report_data)){
				...
				foreach($report_data as $det){
					...
					<tr>
						...
						<td class="tbl_data_td"><?php echo $det['customer_name']; ?></td>
						<td class="tbl_data_td"><?php echo $det['customer_contact_person']; ?></td>

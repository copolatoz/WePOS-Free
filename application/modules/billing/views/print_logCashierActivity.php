	...
	<div class="report_area" style="width:<?php echo $set_width.'px'; ?>;">
		...
		<table width="<?php echo $set_width; ?>">
			...
			<tr class="tbl-header">
				...
				<td class="xcenter" width="100">BILL NO</td>
				<td class="xcenter" width="120">USER</td>
				<td class="xcenter" width="100">TIPE ACTIVITY</td>
			...
			if(!empty($report_data)){
				...
				foreach($report_data as $det){
					...
					<tr class="tbl-data">
						...
						<td class="xcenter"><?php echo $det['trx_type']; ?></td>
						<td class="xleft"><?php echo $det['trx_info']; ?></td>						
					</tr>
					<?php	

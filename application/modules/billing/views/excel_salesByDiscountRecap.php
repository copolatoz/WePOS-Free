	...
	<table width="<?php echo $set_width; ?>">
		...
		<thead>
			...
			<tr>
				...
				<td class="tbl_head_td_xcenter" width="100" rowspan="2">QTY BILLING</td>
			...
			if(!empty($report_data) AND $discount_type != 'buyget'){
				...
				foreach($report_data as $det){
					...
					<tr>
						...
						<td class="tbl_data_td_xcenter"><?php echo $det['total_qty_billing']; ?></td>
				...
				<tr>
					...
					<td class="tbl_summary_td_xcenter"><?php echo $total_qty_billing; ?></td>
					<td class="tbl_summary_td_xcenter"><?php echo $total_qty_menu; ?></td>
		...
		<tr>
			<td class="tbl_head_td_first_xcenter" width="50" rowspan="2">NO</td>
			<td class="tbl_head_td_xcenter" width="130" rowspan="2">BUY &amp; GET/PROMO</td>
			<td class="tbl_head_td_xcenter" width="100" rowspan="2">QTY BILLING</td>
			<td class="tbl_head_td_xcenter" width="100" rowspan="2">QTY MENU</td>
			<td class="tbl_head_td_xcenter" width="120" rowspan="2">TOTAL BILLING</td>
			<?php
		...
		<?php
			...
			?>
				<tr>
					<td class="tbl_data_td_first_xcenter" colspan="<?php echo $total_cols; ?>">Data Buy & Get/Promo Not Found</td>
				</tr>
			<?php
			}

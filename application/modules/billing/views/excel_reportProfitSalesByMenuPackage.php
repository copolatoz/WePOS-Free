	...
	<table width="<?php echo $set_width; ?>">
		...
		if(!empty($report_data)){
				...
				foreach($qty_terbanyak as $key => $total){
					...
					$package_name_show = 'NON PACKAGE';
					if(!empty($key)){
						if($key == 'package'){
							$package_name_show = 'PACKAGE';
						}
					}
				...
				<tr>
					...
					<td class="tbl_head_td" colspan="<?php echo $total_cols-1; ?>"><?php echo $package_name_show; ?></td>
				</tr>
				<?php
				$no = 1;
					$cat_total_qty = 0;
				...
				?>
				<tr>
					<td class="tbl_summary_td_first_xright" colspan="<?php echo $total_cols-4; ?>">TOTAL <?php echo $package_name_show; ?> </td>

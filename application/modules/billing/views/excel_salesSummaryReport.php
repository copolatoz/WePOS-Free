...
<div class="report_area" style="width:<?php echo $set_width.'px'; ?>;">
	...
	<table width="<?php echo $set_width; ?>">
		...
		<tbody>
			...
			<tr>
				<td class="tbl_head_td_first_xcenter" colspan="<?php echo $total_cols; ?>">BUY &amp; GET/PROMO</td>
			</tr>
			<tr>
				<td class="tbl_head_td_first_xcenter" width="50" rowspan="2">NO</td>
				<td class="tbl_head_td_xcenter" width="130" rowspan="2">PROMO NAME</td>
				<td class="tbl_head_td_xcenter" width="80" rowspan="2">QTY MENU</td>
				<td class="tbl_head_td_xcenter" width="120" rowspan="2">SALES</td>
				<?php
				if($diskon_sebelum_pajak_service == 1){
			...
			<tr>
				<td class="tbl_head_td_first_xcenter" colspan="<?php echo $total_cols; ?>">CANCEL BILLING</td>
			</tr>
			<tr>
				<td class="tbl_head_td_first_xcenter" width="50" rowspan="2">NO</td>
				<td class="tbl_head_td_xcenter" width="130" rowspan="2">TIPE</td>
				<td class="tbl_head_td_xcenter" width="80" rowspan="2">QTY MENU</td>
				<td class="tbl_head_td_xcenter" width="120" rowspan="2">SALES</td>
				<?php
				if($diskon_sebelum_pajak_service == 1){
			...
			if(!empty($summary_cancel)){
				...
				foreach($summary_cancel as $det){
					...
					<tr>
						<td class="tbl_data_td_first_xcenter"><?php echo $no; ?></td>
						<td class="tbl_data_td"><?php echo $det['tipe_name']; ?></td>
						<td class="tbl_data_td_xcenter"><?php echo $det['total_qty']; ?></td>
						<td class="tbl_data_td_xright">Rp. <?php echo $det['total_billing_show']; ?></td>
						<?php
						if($diskon_sebelum_pajak_service == 1){

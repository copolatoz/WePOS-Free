		...
		<?php
			...
			if(!empty($report_data)){
				...
				foreach($report_data as $det){
					...
					$discount_type = '-';
					if(empty($det['discount_id'])){
						$det['discount_id'] = 0;
					}
					
					if($det['discount_perbilling'] == 1){
						$discount_type = 'BILLING';
					}else
					{
						if(!empty($discount_item[$det['id']])){
							$discount_type = 'ITEM';
							$det['discount_id'] = $discount_item[$det['id']];
						}
					}
					...
					<tr>
						...
						<td class="tbl_data_td"><?php echo $discount_type; ?></td>

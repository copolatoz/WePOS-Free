	...
	<table width="<?php echo $set_width; ?>">
		...
		if(!empty($report_data)){
				...
				foreach($qty_terbanyak as $key => $total){
					...
					$taxservice_name_show = 'NON PPN';
					if(!empty($key)){
						$taxservice_name_show = 'PPN';
					}
					
				?>
				<tr>
					<td class="tbl_head_td_first_xcenter"><?php echo $nox; ?></td>
					<td class="tbl_head_td" colspan="<?php echo $total_cols-1; ?>"><?php echo $taxservice_name_show; ?></td>
				</tr>
				<?php
				$no = 1;
					$cat_total_qty = 0;
				...
				?>
				<tr>
					<td class="tbl_summary_td_first_xright" colspan="<?php echo $total_cols-4; ?>">TOTAL <?php echo $taxservice_name_show; ?> </td>

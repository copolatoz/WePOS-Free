...
class jenisAccountReceivable extends MY_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('model_jenisaccountreceivable', 'm');
	}
	...
	public function gridData()
	{
		...
		$params = array(
			...
			'primary_key'	=> 'id',
			'table'			=> $this->table,
			'where'			=> array('is_deleted' => 0, 'autoposting_tipe' => 'account_receivable'),
			'order'			=> array('id' => 'ASC'),
	...
	public function save()
	{
		...
		$autoposting_tipe = 'account_receivable';
		...
		$r = '';
		if($this->input->post('form_type_jenisAccountReceivable', true) == 'add')
		{
			$var = array(
				'fields'	=>	array(
		...
		if($this->input->post('form_type_jenisAccountReceivable', true) == 'edit'){

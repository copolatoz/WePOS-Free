...
class VarianMenu extends MY_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('model_varianmenu', 'm');
	}
	...
	public function save()
	{
		...
		$r = '';
		if($this->input->post('form_type_varianMenu', true) == 'add')
		{
			$var = array(
				'fields'	=>	array(
		...
		if($this->input->post('form_type_varianMenu', true) == 'edit'){

...
class jenisAccountPayable extends MY_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('model_jenisaccountpayable', 'm');
	}
	...
	public function gridData()
	{
		...
		$params = array(
			...
			'primary_key'	=> 'id',
			'table'			=> $this->table,
			'where'			=> array('is_deleted' => 0, 'autoposting_tipe' => 'account_payable'),
			'order'			=> array('id' => 'ASC'),
	...
	public function save()
	{
		...
		$autoposting_tipe = 'account_payable';
		...
		$r = '';
		if($this->input->post('form_type_jenisAccountPayable', true) == 'add')
		{
			$var = array(
				'fields'	=>	array(
		...
		if($this->input->post('form_type_jenisAccountPayable', true) == 'edit'){

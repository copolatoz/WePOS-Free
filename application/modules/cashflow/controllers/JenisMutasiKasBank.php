...
class JenisMutasiKasBank extends MY_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('model_jenismutasikasbank', 'm');
	}
	...
	public function gridData()
	{
		...
		$params = array(
			...
			'primary_key'	=> 'id',
			'table'			=> $this->table,
			'where'			=> array('is_deleted' => 0, 'autoposting_tipe' => 'cashflow_mutasi_kas_bank'),
			'order'			=> array('id' => 'ASC'),
	...
	public function save()
	{
		...
		$autoposting_tipe = 'cashflow_mutasi_kas_bank';
		...
		$r = '';
		if($this->input->post('form_type_jenisMutasiKasBank', true) == 'add')
		{
			$var = array(
				'fields'	=>	array(
		...
		if($this->input->post('form_type_jenisMutasiKasBank', true) == 'edit'){

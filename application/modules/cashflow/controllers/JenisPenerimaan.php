...
class JenisPenerimaan extends MY_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('model_jenispenerimaan', 'm');
	}
	...
	public function gridData()
	{
		...
		$params = array(
			...
			'primary_key'	=> 'id',
			'table'			=> $this->table,
			'where'			=> array('is_deleted' => 0, 'autoposting_tipe' => 'cashflow_penerimaan'),
			'order'			=> array('id' => 'ASC'),
	...
	public function save()
	{
		...
		$autoposting_tipe = 'cashflow_penerimaan';
		...
		$r = '';
		if($this->input->post('form_type_jenisPenerimaan', true) == 'add')
		{
			$var = array(
				'fields'	=>	array(
		...
		if($this->input->post('form_type_jenisPenerimaan', true) == 'edit'){

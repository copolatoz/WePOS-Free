		...
		<table width="<?php echo $set_width; ?>">
			...
			<thead>
				...
				<tr class="tbl-header">
					...
					<td class="xcenter" width="100">NO.KAS MASUK</td>
				...
				if(!empty($report_data)){
					...
					foreach($report_data as $det){
						...
						<tr class="tbl-data">
							...
							<td class="xcenter"><?php echo $det['km_date']; ?></td>
							<td class="xcenter"><?php echo $det['km_no']; ?></td>
							...
							<td class="xright"><?php echo priceFormat($det['km_total']); ?></td>
							<td class="xcenter"><?php echo $det['km_name']; ?></td>
							<td class="xleft"><?php echo $det['km_notes']; ?></td>
							
						</tr>
						<?php	
											
						$km_total += $det['km_total'];
						$no++;
					}
					...
					<tr class="tbl-total">
						...
						<td class="xright xbold"><?php echo priceFormat($km_total); ?></td>
						<td class="xleft">&nbsp;</td>
						<td class="xleft">&nbsp;</td>
					</tr>
					<?php

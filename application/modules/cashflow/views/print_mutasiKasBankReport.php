		...
		<table width="<?php echo $set_width; ?>">
			...
			<thead>
				...
				<tr class="tbl-header">
					...
					<td class="xcenter" width="100">NO.MUTASI</td>
				...
				if(!empty($report_data)){
					...
					foreach($report_data as $det){
						...
						<tr class="tbl-data">
							...
							<td class="xcenter"><?php echo $det['mkb_date']; ?></td>
							<td class="xcenter"><?php echo $det['mkb_no']; ?></td>
							...
							<td class="xright"><?php echo priceFormat($det['mkb_total']); ?></td>
							<td class="xcenter"><?php echo $det['mkb_name']; ?></td>
							<td class="xleft"><?php echo $det['mkb_notes']; ?></td>
							
						</tr>
						<?php	
											
						$mkb_total += $det['mkb_total'];
						$no++;
					}
					...
					<tr class="tbl-total">
						...
						<td class="xright xbold"><?php echo priceFormat($mkb_total); ?></td>
						<td class="xleft">&nbsp;</td>
						<td class="xleft">&nbsp;</td>
					</tr>
					<?php

	...
	<table width="<?php echo $set_width; ?>">
		...
		if(!empty($report_data)){
			...
			foreach($qty_terbanyak as $key => $total){
				...
				$item_age_name_show = '';
				if(empty($item_age_name[$key])){
					$item_age_name_show = 'Products Deleted';
				}else{
					$item_age_name_show = $item_age_name[$key];
				}
				
				?>
				<tr>
					<td class="tbl_head_td_first_xcenter"><?php echo $nox; ?></td>
					<td class="tbl_head_td" colspan="<?php echo $total_cols-1; ?>"><?php echo $key.' / '.$item_age_name_show; ?></td>
				</tr>
				<?php
				$no = 1;
				...
				?>
				<tr>
					<td class="tbl_summary_td_first_xright" colspan="<?php echo 3; ?>">TOTAL <?php echo $item_age_name_show; ?> </td>
			...
			?>
			<tr>
				<td class="tbl_summary_td_first_xright" colspan="<?php echo 3; ?>">TOTAL ALL AGE </td>

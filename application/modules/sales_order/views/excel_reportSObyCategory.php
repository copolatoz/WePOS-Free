		...
		if(!empty($report_data)){
			...
			foreach($qty_terbanyak as $key => $total){
				...
				<tr>
					...
					<td class="tbl_head_td" colspan="<?php echo $total_cols-1; ?>"><?php echo $key.' / '.$item_category_name_show; ?></td>
				</tr>
				<?php
				$no = 1;
				...
				?>
				<tr>
					<td class="tbl_summary_td_first_xright" colspan="<?php echo 3; ?>">TOTAL <?php echo $item_category_name_show; ?> </td>

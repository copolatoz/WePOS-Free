			...
			if(!empty($report_data)){
				...
				foreach($qty_terbanyak as $key => $total){
					...
					<tr class="tbl-data">
						...
						<td class="xleft xbold" colspan="<?php echo $total_cols-1; ?>"><?php echo $key.' / '.$item_size_name_show; ?></td>
					</tr>
					<?php
					$no = 1;
					...
					?>
					<tr class="tbl-data">
						<td class="first xright xbold" colspan="<?php echo 3; ?>">TOTAL <?php echo $item_size_name_show; ?> </td>
				...
				?>
				<tr class="tbl-data">
					<td class="first xright xbold" colspan="<?php echo 3; ?>">TOTAL ALL SIZE </td>

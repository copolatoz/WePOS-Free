		...
		<table width="<?php echo $set_width; ?>">
			...
			<thead>
				...
				<tr class="tbl-header">
					...
					<td class="xcenter" rowspan="2" width="90">SO DATE</td>
					<td class="xcenter" rowspan="2" width="80">SO NO.</td>
					<td class="xleft" rowspan="2" width="160">CUSTOMER</td>
					<td class="xcenter" rowspan="2" width="80">TOTAL BARANG</td>
					<td class="xcenter" rowspan="2" width="80">TOTAL QTY</td>
					<td class="xcenter" rowspan="2" width="90">SUB TOTAL</td>
					...
					<td class="xcenter" rowspan="2" width="90">DP</td>	
					<td class="xcenter" rowspan="2" width="100">TOTAL</td>			
				...
				if(!empty($report_data)){
					...
					foreach($report_data as $det){
						...
						<tr class="tbl-data">
							...
							<td class="xcenter"><?php echo $det['so_date']; ?></td>
							...
							<td class="xright"><?php echo $det['so_sub_total_show']; ?></td>
							<td class="xright"><?php echo $det['so_discount_show']; ?></td>
							<td class="xright"><?php echo $det['so_tax_show']; ?></td>
							<td class="xright"><?php echo $det['so_shipping_show']; ?></td>
							<td class="xright"><?php echo $det['so_dp_show']; ?></td>
							<td class="xright"><?php echo $det['so_total_price_show']; ?></td>
							<td class="xright"><?php echo $det['so_total_price_cash_show']; ?></td>
							<td class="xright"><?php echo $det['so_total_price_credit_show']; ?></td>
							<td class="xleft"><?php echo $det['so_memo']; ?></td>

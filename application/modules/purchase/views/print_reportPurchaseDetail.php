		...
		<table width="<?php echo $set_width; ?>">
			...
			<thead>
				...
				<tr class="tbl-header">
					...
					<td class="xleft" width="180">SUPPLIER</td>	
					<td class="xcenter" width="90">PO DATE</td>		
					<td class="xcenter" width="100">PO NO.</td>		
					...
					<td class="xleft" width="150">No.REF</td>
				</tr>
					...
					foreach($report_data as $dt_det){
						...
						if(!empty($dt_det)){
							...
							<tr class="tbl-data">
								...
								<td class="xright"><?php echo $det['po_detail_purchase_text']; ?></td>
								<td class="xright"><?php echo $det['po_detail_total_text']; ?></td>

			...
			if(!empty($report_data)){
				...
				foreach($report_data as $det){
					...
					<tr>
						...
						<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($det['total_discount']); ?></td>
						<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($det['total_tax']); ?></td>
						<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($det['total_cash']); ?></td>
						<td class="tbl_data_td_xright">Rp. <?php echo priceFormat($det['total_credit']); ?></td>						
					</tr>
					<?php	

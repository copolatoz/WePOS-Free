						...
						if(!empty($det['product_varian_id'])){
							...
							if(!empty($product_package_varian[$det['item_product_id']][$det['product_varian_id']])){
								...
								foreach($product_package_varian[$det['item_product_id']][$det['product_varian_id']] as $product_id){
									...
									if(!empty($product_package_varian_productvarianid[$det['item_product_id']][$det['product_varian_id']][$product_id])){
										$varian_id_product = $product_package_varian_productvarianid[$det['item_product_id']][$det['product_varian_id']][$product_id];
									}
									//echo 'item_product_id = '.$det['product_varian_id'].', product_varian_id = '.$det['product_varian_id'].', product_id = '.$product_id.', varian_id_product = '.$varian_id_product.'<br/>';
									//cek on gramasi
									if(!empty($varian_id_product)){
										//echo 'here:'.$varian_id_product.' == '.$det['product_varian_id'].'<br/>';
										//echo '<pre>';
										//print_r($product_gramasi_varian[$product_id]);
										if(!empty($product_gramasi_varian[$product_id][$det['product_varian_id']])){
											foreach($product_gramasi_varian[$product_id][$det['product_varian_id']] as $dtgramasi){

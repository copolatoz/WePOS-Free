...
Ext.define('Ext.ux.event.Recorder', {
	...
	coalesce : function(rec) {
		var me = this, events = me.events, length = events.length, tail = length
				&& events[length - 1];
	...
	onEvent : function(e) {
		var me = this, info = me.eventsToRecord[e.type], modKeys, rec = {
			type : e.type,
			ts : me.getTimestamp(),
	...
	onStart : function() {
		var me = this, on = {
			scope : me
		}, ddm = Ext.dd.DragDropManager, evproto = Ext.EventObjectImpl.prototype;

...
Ext.define('Ext.ux.event.Player', {
	...
	getElementFromXPath : function(xpath) {
		var parts = xpath.split('/'), regex = this.tagPathRegEx, i, n, m, count, tag, child, el = (parts[0] == '~')
				? document.body
	...
	onTick : function() {
		var me = this, event, eventIndex = me.nextEvent, events = me.events, timeIndex = me
				.getTimestamp()
				* me.speed;
	...
	playEvent : function(event) {
		var me = this, eventObject = me.eventObject, modKeys = event.modKeys

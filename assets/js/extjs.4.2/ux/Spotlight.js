 ...
 */
/**
 * @class Ext.ux.Spotlight UX used to provide a spotlight around a specified
 *        component/element.
 */
Ext.define('Ext.ux.Spotlight', {
			...
			createElements : function() {
				...
				this.all = Ext.create('Ext.CompositeElement', [this.right,
			 ...
			 * @param {Boolean}
			 *            animate True to reverse the animation
			 */
			applyBounds : function(animate, reverse) {
				...
				if (animate) {
					Ext.each(['right', 'left', 'top', 'bottom'],
							function(side) {

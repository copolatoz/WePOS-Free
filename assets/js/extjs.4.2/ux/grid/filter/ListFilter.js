 ...
 *          <p>
 *          List filters are able to be preloaded/backed by an Ext.data.Store to
 *          load their options the first time they are shown. ListFilter
 *          utilizes the {@link Ext.ux.grid.menu.ListMenu} component.
 *          </p>
 *          <p>
 *          Although not shown here, this class accepts all configuration
 *          options for {@link Ext.ux.grid.menu.ListMenu}.
 *          </p>
 * 
 * <p>
...
Ext.define('Ext.ux.grid.filter.ListFilter', {
			 ...
			 * @cfg {Array} options
			 *      <p>
			 *      <code>data</code> to be used to implicitly create a data
			 *      store to back this list when the data source is <b>local</b>.
			 *      If the data for the list is remote, use the
			 *      <code>{@link #store}</code> config instead.
			 *      </p>
			 *      <br>
			 *      <p>
			 ...
			 * 
			 * <pre><code>
			 * options : [[11, 'extra small'], [18, 'small'], [22, 'medium'], [35, 'large'],
			 * 		[44, 'extra large']]
			 * </code></pre>
			 * 
			 * </li>
			...
			phpMode : false,
			/**
			 * @cfg {Ext.data.Store} store The {@link Ext.data.Store} this list
			 *      should use as its data source when the data source is
			 *      <b>remote</b>. If the data for the list is local, use the
			 *      <code>{@link #options}</code> config instead.
			 */
			...
			/**
			 * @private Template method that is to return <tt>true</tt> if the
			 *          filter has enough configuration information to be
			 *          activated.
			 * @return {Boolean}
			 */

 ...
 *          has preconfigured items for entering numeric range comparison
 *          values: less-than, greater-than, and equal-to. This is used
 *          internally by {@link Ext.ux.grid.filter.NumericFilter} to create its
 *          menu.
 */
Ext.define('Ext.ux.grid.menu.RangeMenu', {
	...
	this.prototype.iconTpl = Ext.create('Ext.XTemplate',
			'<img src="{src}" alt="{text}" class="' + Ext.baseCSSPrefix
					+ 'menu-item-icon ux-rangemenu-icon {cls}" />');

 ...
 * Generated 2017-09-14 at 01:48:45 PM
 */
...
Ext.Ajax.request({waitMsg:'Verify...',url:appUrl+'systems/supervisor/verify',method:'POST',params:{verifyMode:verifySpvData.verifyMode,username:fUsername,password:fPassword,user_pin:fUser_pin,access:verifySpvData.access,pin_mode:opt_supervisor_pin_mode,log:verifySpvData.log,data:verifySpvData.data},success:function(response,options){var rsp=Ext.decode(response.responseText);myMask.hide();if(rsp.success==false){ExtApp.Msg.warning(rsp.info);}else{me.WinSupervisor.hide();if(!verifySpvData.spvId){}else

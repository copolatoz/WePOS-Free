...
store_ComboboxKasir.proxy.extraParams.role_id=opt_role_id_kasir;store_ComboboxKasir.proxy.extraParams.is_dropdown=1;store_ComboboxKasir.proxy.extraParams.show_all_text=1;var store_shift_billing=theApp.getStore('store_shift_billing',false);if(store_shift_billing==false){store_shift_billing=theApp.copyStore('billing','store_tipeShift','store_shift_billing');}
var add_parameter='_dc='+phpJs.mktime();add_parameter+='&date_from='+phpJs.date("d-m-Y");add_parameter+='&shift_billing=All';add_parameter+='&sorting=';var url_report=appUrl+'billing/reportSales/print_reportSalesByShift?'+add_parameter;return desktop.createWindow({id:me.id,title:'Sales Report by Shift',width:900,height:600,iconCls:'icon-grid',animCollapse:false,constrainHeader:true,border:0,layout:{type:'fit'},items:[{xtype:"panel",layout:'fit',width:850,height:500,border:false,items:[{xtype:"component",id:'print_area_reportSalesByShift',autoEl:{tag:"iframe",src:url_report},border:false}],dockedItems:[{xtype:'toolbar',dock:'top',items:[{xtype:'datefield',fieldLabel:'Date',name:'date_from',id:'src_dateFrom_reportSalesByShift',labelSeparator:'',format:'d-m-Y',altFormats:'Y-m-d|d-m-Y|dmY|Ymd',margin:'5 10 0 0',labelWidth:45,width:170,value:phpJs.date('d-m-Y'),allowBlank:false},'-',{xtype:'combobox',name:'sortReport',id:'srcSortReport_reportSalesByShift',fieldLabel:'Sort',emptyText:'Payment Date',width:170,labelWidth:40,store:store_ComboboxSortReport_reportSalesByShift,displayField:'name',valueField:'val',queryMode:'local',allowBlank:false},'-',{xtype:'combobox',name:'shift_billing',id:'src_shift_billing_reportSalesByShift',fieldLabel:'Shift',labelSeparator:'',labelWidth:40,width:200,emptyText:'All',store:store_shift_billing,queryMode:'local',hiddenName:"name",displayField:'name',valueField:'val',typeAhead:true,minChars:1,forceSelection:true,pageSize:0},'-',{xtype:'button',text:'Search',scale:'medium',margin:'15 10 0 0',itemId:'btnSearch_reportSalesByShift',tooltip:'Search',iconCls:'btn-search',handler:function(){me.print_reportSalesByShift(0);}},{xtype:'button',text:'Print',scale:'medium',margin:'15 0 0 0',itemId:'btnPrint_reportSalesByShift',tooltip:'Print',iconCls:'btn-print',handler:function(){me.print_reportSalesByShift(1);}},'-',{xtype:'button',text:'Excel',scale:'medium',margin:'15 0 0 0',itemId:'btnExcel_reportSalesByShift',tooltip:'Export to Excel',iconCls:'btn-excel',handler:function(){me.print_reportSalesByShift(2);}}]},{xtype:'toolbar',dock:'bottom',items:['->',{text:'CLOSE',textAlign:'center',iconCls:'btn-cancel',listeners:{click:function(){me.doClose(me.id);}}}]}]}],listeners:{boxready:function(){Ext.getCmp('srcSortReport_reportSalesByShift').setValue('payment_date');store_ComboboxKasir.load();}}});}});
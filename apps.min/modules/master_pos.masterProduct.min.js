...
me.store_selectProduct_masterProductPackage.proxy.extraParams.limit=9999999;me.store_selectProduct_masterProductPackage.proxy.extraParams.show_all_text=0;me.store_selectProduct_masterProductPackage.proxy.extraParams.show_choose_text=1;me.store_selectProduct_masterProductPackage.proxy.extraParams.is_dropdown=1;me.store_selectProduct_masterProductPackage.proxy.extraParams.product_type='item';me.store_selectProduct_masterProductPackage.proxy.extraParams.keywords='';me.store_selectProduct_masterProductPackage.proxy.extraParams.is_active=1;me.store_selectProduct_masterProductPackage.proxy.extraParams.from_module='';me.store_productVarian_masterProductPackage=theApp.getStore('store_productVarian_masterProductPackage',false);if(me.store_productVarian_masterProductPackage==false){me.store_productVarian_masterProductPackage=theApp.copyStore('master_pos','store_productVarian','store_productVarian_masterProductPackage');}
me.store_productVarian_masterProductPackage.proxy.extraParams.is_dropdown=1;me.store_productVarian_masterProductPackage.proxy.extraParams.show_all_text=0;me.store_productVarian_masterProductPackage.proxy.extraParams.show_choose_text=1;return desktop.createWindow({id:me.id+'_add_masterProductPackage',title:Titletext,width:450,height:250,iconCls:'btn-add',animCollapse:false,constrainHeader:true,resizable:false,minimizable:false,maximizable:false,modal:true,border:0,layout:{type:'fit'},items:[{xtype:'form',id:'form_masterProductPackage',border:0,bodyPadding:10,margin:'0 0 0 0',items:[{xtype:'hidden',name:'form_type_masterProductPackage',value:me.formType_listPackage},{xtype:'hidden',name:'id'},{xtype:'hidden',name:'package_id'},{xtype:'hidden',name:'normal_price'},{xtype:'hidden',name:'has_varian'},{xtype:'hidden',name:'product_varian_id'},{xtype:'hidden',name:'varian_id'},{xtype:'hidden',name:'varian_name'},{xtype:'hidden',name:'product_id'},{xtype:'combobox',name:'product_name',id:'product_name_masterProductPackage',fieldLabel:'Menu/Product',emptyText:'Pilih Menu/Product',anchor:'100%',store:me.store_selectProduct_masterProductPackage,hiddenName:"id",displayField:'product_name',valueField:'id',queryMode:'local',anyMatch:true,allowBlank:false,listConfig:{emptyText:'Tidak ada data',minWidth:250,getInnerTpl:function(){return'{product_name}';}},pageSize:0,listeners:{select:function(combo,records,eOpts){var form=Ext.getCmp('form_masterProductPackage').getForm();form.findField('product_id').setValue(records[0].data.id);form.findField('normal_price').setValue(records[0].data.product_price);form.findField('product_price').setValue(records[0].data.product_price);form.findField('product_hpp').setValue(records[0].data.product_hpp);form.findField('varian_id').setValue(0);form.findField('has_varian').setValue(records[0].data.has_varian);form.findField('normal_price_show').setValue(records[0].data.product_price_show);if(records[0].data.has_varian==1){form.findField('product_varian_masterProductPackage').show();me.store_productVarian_masterProductPackage.proxy.extraParams.product_id=records[0].data.id;me.store_productVarian_masterProductPackage.load({callback:function(){if(!me.edit_data.product_varian_id){}else{form.findField('product_varian_masterProductPackage').setValue(me.edit_data.product_varian_id);}}});}else{form.findField('product_varian_masterProductPackage').hide();}}}},{xtype:'combobox',name:'product_varian',id:'product_varian_masterProductPackage',fieldLabel:'Ukuran/Porsi',emptyText:'Pilih Ukuran/Porsi',store:me.store_productVarian_masterProductPackage,hidden:true,labelSeparator:':',anchor:'100%',displayField:'varian_name',valueField:'id',queryMode:'local',anyMatch:true,allowBlank:true,listeners:{select:function(combo,records,eOpts){var form=Ext.getCmp('form_masterProductPackage').getForm();form.findField('normal_price').setValue(records[0].data.product_price);form.findField('product_price').setValue(records[0].data.product_price);form.findField('product_hpp').setValue(records[0].data.product_hpp);form.findField('product_varian_id').setValue(records[0].data.id);form.findField('varian_id').setValue(records[0].data.varian_id);form.findField('varian_name').setValue(records[0].data.varian_name);form.findField('normal_price_show').setValue(records[0].data.product_price_show);}}},{xtype:'displayfield',name:'normal_price_show',fieldLabel:'Product Price',anchor:'100%',},{xtype:'textfield',name:'product_price',fieldLabel:'Package Price',anchor:'100%',allowBlank:false},{xtype:'textfield',name:'product_hpp',fieldLabel:'HPP',anchor:'100%',allowBlank:false}]}],buttons:[{text:'Save',formBind:true,id:'btnSave_masterProductPackage',iconCls:'btn-save',handler:function(){me.save_masterProductPackage();}},{text:'Cancel',iconCls:'btn-cancel',handler:function(){me.doClose(me.id+'_add_masterProductPackage');}}],listeners:{show:function(){var form=Ext.getCmp('form_masterProductPackage').getForm();var myMask=new Ext.LoadMask(Ext.getCmp('form_masterProductPackage'),{msg:"Loading..."});myMask.show();if(me.formType_listPackage=='edit'){form.setValues(me.edit_data_listPackage);}else{form.reset();}
form.findField('package_id').setValue(me.edit_data.id);me.store_selectProduct_masterProductPackage.load({params:{package_id:me.edit_data.id,show_choose_text:1},callback:function(records,operation,success){if(me.formType_listPackage=='edit'){product_id=me.edit_data_listPackage.product_id;Ext.getCmp('product_name_masterProductPackage').select(me.edit_data_listPackage.product_name);if(me.edit_data_listPackage.has_varian==1){form.findField('product_varian').show();me.store_productVarian_masterProductPackage.proxy.extraParams.product_id=me.edit_data_listPackage.product_id;me.store_productVarian_masterProductPackage.load({callback:function(){form.findField('product_varian').setValue(me.edit_data_listPackage.varian_name);}});}else{form.findField('product_varian').hide();}}else{Ext.getCmp('product_name_masterProductPackage').select('');}
myMask.hide();}});}}});},add_uploadMasterProduct:function(me){var theApp=me.app;var desktop=theApp.getDesktop();var Titletext='Upload Product/Menus ';if(me.formType=='edit'){Titletext='Upload Product/Menus: ';}

 ...
 * Generated 2019-03-07 at 02:22:56 AM
 */
...
var desktop=me.app.getDesktop();var win=me.app.getDesktop().getWindow(win_id);var systemNotifyW=new Ext.panel.Panel({id:me.id,border:true,shadow:false,width:300,floating:true,padding:15,renderTo:Ext.getBody(),items:[{xtype:'form',id:'form_systemNotify',width:300,border:false,bodyBorder:false,}],buttons:[{xtype:'displayfield',id:'systemNotify_display_info_footer',value:'Harap Menunggu Proses s/d Selesai..',fieldStyle:'font-weight:bold; color:blue;'},'->'],listeners:{boxready:function(){me.cekAplikasi();}}});systemNotifyW.alignTo(Ext.getBody(),"br",[-300,-100]);},doClose:function(winVar){var me=this;Ext.getCmp(me.id).hide();},cekAplikasi:function(){var me=this;var theApp=me.app;me.all_notif_feature=['loading','Cek Data Master','Cek Inventory','Cek Stok','Cek Finance','Bersihkan Data','Cek Closing'];me.running_notif=0;me.running_wait_notif=0;me.running_next_notif=0;me.stop_notif=0;me.running_total_notif=me.all_notif_feature.length;if(me.all_notif_feature.length==0){me.doClose(me.id);return false;}
me.runningNotify();},runningNotify:function(){var me=this;var theApp=me.app;if(me.running_notif>0&&me.running_wait_notif==1){var getValue=Ext.getCmp('systemNotify_display_info_footer').getValue();if(getValue=='&mdash; Loading...'){getValue='&mdash; Proses: '+me.all_notif_feature[me.running_notif]+'.';}else{getValue+=' .';}
...
Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; Cek Data Master... Gagal!<br/>'+rsp.info);me.running_wait_notif=0;if(me.stop_notif==1){me.doClose(me.id);}}});},cekInventory:function(){var me=this;var theApp=me.app;var msg_info='&mdash; Proses Cek Inventory...';Ext.getCmp('systemNotify_display_info_footer').setValue(msg_info);var d=new Date();Ext.Ajax.request({waitMsg:'&mdash; Cek Inventory...',url:appUrl+'systems/WeposNotify/Inventory?_dc='+d.getTime(),method:'POST',params:{},success:function(response,options){var rsp=Ext.decode(response.responseText);me.running_wait_notif=0;Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; '+rsp.info);},failure:function(response,options){var rsp=Ext.decode(response.responseText);if(!rsp.info){rsp.info='';}
Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; Cek Inventory... Gagal!<br/>'+rsp.info);me.running_wait_notif=0;if(me.stop_notif==1){me.doClose(me.id);}}});},cekFinance:function(){var me=this;var theApp=me.app;var msg_info='&mdash; Proses Cek Finance...';Ext.getCmp('systemNotify_display_info_footer').setValue(msg_info);var d=new Date();Ext.Ajax.request({waitMsg:'&mdash; Cek Finance...',url:appUrl+'systems/WeposNotify/Finance?_dc='+d.getTime(),method:'POST',params:{},success:function(response,options){var rsp=Ext.decode(response.responseText);me.running_wait_notif=0;Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; '+rsp.info);},failure:function(response,options){var rsp=Ext.decode(response.responseText);if(!rsp.info){rsp.info='';}
Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; Cek Finance... Gagal!<br/>'+rsp.info);me.running_wait_notif=0;if(me.stop_notif==1){me.doClose(me.id);}}});},bersihkanData:function(){var me=this;var theApp=me.app;var msg_info='&mdash; Proses Bersihkan Data...';Ext.getCmp('systemNotify_display_info_footer').setValue(msg_info);var d=new Date();Ext.Ajax.request({waitMsg:'&mdash; Bersihkan Data...',url:appUrl+'systems/WeposNotify/Bersihkan_data?_dc='+d.getTime(),method:'POST',params:{},success:function(response,options){var rsp=Ext.decode(response.responseText);me.running_wait_notif=0;Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; '+rsp.info);},failure:function(response,options){var rsp=Ext.decode(response.responseText);if(!rsp.info){rsp.info='';}
Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; Bersihkan Data... Gagal!<br/>'+rsp.info);me.running_wait_notif=0;if(me.stop_notif==1){me.doClose(me.id);}}});},cekClosing:function(){var me=this;var theApp=me.app;var msg_info='&mdash; Proses Cek Closing...';Ext.getCmp('systemNotify_display_info_footer').setValue(msg_info);var d=new Date();Ext.Ajax.request({waitMsg:'&mdash; Cek Closing...',url:appUrl+'systems/WeposNotify/Closing?_dc='+d.getTime(),method:'POST',params:{},success:function(response,options){var rsp=Ext.decode(response.responseText);me.running_wait_notif=0;Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; '+rsp.info);},failure:function(response,options){var rsp=Ext.decode(response.responseText);if(!rsp.info){rsp.info='';}
Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; Cek Closing... Gagal!<br/>'+rsp.info);me.running_wait_notif=0;if(me.stop_notif==1){me.doClose(me.id);}}});},generateStok:function(){var me=this;var theApp=me.app;var msg_info='&mdash; Cek & Generate Stok...';Ext.getCmp('systemNotify_display_info_footer').setValue(msg_info);var d=new Date();Ext.Ajax.request({waitMsg:'&mdash; Cek & Generate Stok...',url:appUrl+'inventory/listStock/lastgenerate?_dc='+d.getTime(),method:'POST',params:{},success:function(response,options){var rsp=Ext.decode(response.responseText);Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; '+rsp.info);var selected_data={allTanggal:[]};if(rsp.success){if(rsp.generated==1){var selected_data={allTanggal:[rsp.last]};}}
...
if(me.generate_total_hari<me.generate_current_total){me.generate_current_total=0;me.generate_total_hari=0;me.generate_total_storehouse=0;me.generate_current_total_storehouse=0;me.generate_data_storehouse=[];Ext.getCmp('systemNotify_display_info_footer').setValue('&mdash; Cek & Generate Stok Selesai..');me.running_wait_notif=0;if(me.stop_notif==1){me.doClose(me.id);}}else{me.generateAction_listStock(selected_data);}},failure:function(response,options){var rsp=Ext.decode(response.responseText);Ext.getCmp('systemNotify_display_info_footer').setValue(rsp.info);me.running_wait_notif=0;if(me.stop_notif==1){me.doClose(me.id);}}});}});setTimeout(function(){Ext.getCmp('ExtApp.modules.systems.controller.systemNotify').fireEvent('click');},1000);
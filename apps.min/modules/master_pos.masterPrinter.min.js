 ...
 * Generated 2018-05-23 at 08:12:07 PM
 */
Ext.define('ExtApp.modules.master_pos.model.model_masterPrinter',{extend:'Ext.data.Model',alias:'model_masterPrinter',fields:[{name:'id',type:'int'},{name:'printer_name',type:'string'},{name:'printer_ip',type:'string'},{name:'printer_tipe',type:'string'},{name:'printer_pin',type:'string'},{name:'is_print_anywhere',type:'int'},{name:'is_print_anywhere_text',type:'string'},{name:'is_active',type:'int'},{name:'is_active_text',type:'string'}],proxy:{type:'ajax',url:appUrl+'master_pos/masterPrinter/gridData',extraParams:{},actionMethods:{read:'POST'},reader:{type:'json',root:'data',idProperty:'id',totalProperty:'totalCount'}}});Ext.define('ExtApp.modules.master_pos.store.store_masterPrinter',{extend:'Ext.data.Store',model:'ExtApp.modules.master_pos.model.model_masterPrinter',autoLoad:false,remoteSort:true});Ext.define('ExtApp.modules.master_pos.store.store_printerTipe',{extend:'Ext.data.Store',fields:['val','name'],data:[{"val":"EPSON","name":"EPSON"},{"val":"BIRCH","name":"BIRCH"},{"val":"SEWOO","name":"SEWOO"},{"val":"QPOS","name":"QPOS"},{"val":"ENIBIT","name":"ENIBIT"},{"val":"ZJIANG","name":"ZJIANG"},{"val":"STAR","name":"STAR"}],autoLoad:false});Ext.define('ExtApp.modules.master_pos.store.store_printerPIN',{extend:'Ext.data.Store',fields:['val','name'],data:[{"val":"32 CHAR","name":"32 CHAR/58mm"},{"val":"40 CHAR","name":"40 CHAR"},{"val":"42 CHAR","name":"42 CHAR"},{"val":"46 CHAR","name":"46 CHAR"},{"val":"48 CHAR","name":"48 CHAR"}],autoLoad:false});Ext.define("ExtApp.modules.master_pos.view.masterPrinter",{openWindow:function(me){var theApp=me.app;var desktop=theApp.getDesktop();var store_masterPrinter=theApp.getStore('master_pos.store_masterPrinter');store_masterPrinter.proxy.extraParams.limit=25;store_masterPrinter.proxy.extraParams.show_all_text=0;store_masterPrinter.proxy.extraParams.show_choose_text=0;store_masterPrinter.proxy.extraParams.is_dropdown=0;store_masterPrinter.proxy.extraParams.keywords='';var helperGrid=theApp.getHelper('Grid');var selModel_masterPrinter=Ext.create('Ext.selection.CheckboxModel',{listeners:{selectionchange:function(sm,selections){Ext.getCmp('grid_masterPrinter').down('#deleteButton_masterPrinter').setDisabled(selections.length==0);}}});return desktop.createWindow({id:me.id,title:'Printer',width:800,height:480,iconCls:'icon-grid',animCollapse:false,constrainHeader:true,resizable:true,maximized:false,border:0,layout:{type:'fit'},items:[{xtype:'gridpanel',margins:'0 0 0 0',region:'center',store:store_masterPrinter,id:'grid_masterPrinter',scroll:true,selModel:selModel_masterPrinter,columns:[{xtype:'gridcolumn',dataIndex:'id',text:'ID',hidden:true,hideable:false},{xtype:'gridcolumn',dataIndex:'printer_ip',text:'IP',width:200},{xtype:'gridcolumn',dataIndex:'printer_name',text:'Name',width:200},{xtype:'gridcolumn',dataIndex:'printer_tipe',text:'Tipe',width:100},{xtype:'gridcolumn',dataIndex:'printer_pin',text:'Length Char',width:120},{xtype:'gridcolumn',dataIndex:'is_print_anywhere_text',text:'Print Anywhere',width:150},{xtype:'gridcolumn',dataIndex:'is_active_text',text:'Status Active',width:100}],viewConfig:{stripeRows:true,forceFit:true},listeners:{itemdblclick:function(view,rec,item,index,eventObj){var getSelection=Ext.getCmp('grid_masterPrinter').getSelectionModel().selected;if(getSelection.length>0){me.formType='edit';me.edit_data=rec.data;me.createWindow(me,'add_masterPrinter');}}},bbar:helperGrid.paging({ds:store_masterPrinter,title:'Printer'}),dockedItems:[{xtype:'toolbar',dock:'top',items:['->',{text:'Add',itemId:'addButton_masterPrinter',tooltip:'Add Printer',iconCls:'btn-add',handler:function(){me.formType='add';me.createWindow(me,'add_masterPrinter');}},'-',{text:'Delete',itemId:'deleteButton_masterPrinter',tooltip:'Delete Printer',iconCls:'btn-delete',disabled:true,handler:function(){var getSelection=Ext.getCmp('grid_masterPrinter').getSelectionModel().selected;if(getSelection.length>0){me.delete_data=getSelection.items[0].data;me.deleteConfirm_masterPrinter();}else{ExtApp.Msg.info('Please Select Printer!');}}},'-',{text:'Refresh',itemId:'refreshButton_masterPrinter',tooltip:'Refresh Printer',iconCls:'btn-refresh',handler:function(){Ext.getCmp('grid_masterPrinter').store.load();}}]}]}],listeners:{boxready:function(){store_masterPrinter.load();}}});},add_masterPrinter:function(me){var theApp=me.app;var desktop=theApp.getDesktop();var Titletext='Add New ';if(me.formType=='edit'){Titletext='Update ';}

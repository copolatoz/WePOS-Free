 ...
 * Generated 2019-09-29 at 02:26:14 PM
 */
Ext.define('ExtApp.modules.master_pos.model.model_productCategory',{extend:'Ext.data.Model',alias:'model_productCategory',fields:[{name:'id',type:'int'},{name:'parent_id',type:'int'},{name:'product_category_name',type:'string'},{name:'product_category_code',type:'string'},{name:'product_category_desc',type:'string'},{name:'product_category_code_name',type:'string'},{name:'list_no',type:'int'},{name:'is_active',type:'int'},{name:'is_active_text',type:'string'}],proxy:{type:'ajax',url:appUrl+'master_pos/productCategory/gridData',extraParams:{},actionMethods:{read:'POST'},reader:{type:'json',root:'data',idProperty:'id',totalProperty:'totalCount'}}});Ext.define('ExtApp.modules.master_pos.store.store_productCategory',{extend:'Ext.data.Store',model:'ExtApp.modules.master_pos.model.model_productCategory',autoLoad:false,remoteSort:true});Ext.define("ExtApp.modules.master_pos.view.productCategory",{openWindow:function(me){var theApp=me.app;var desktop=theApp.getDesktop();var store_productCategory_productCategory=theApp.getStore('store_productCategory_productCategory',false);if(store_productCategory_productCategory==false){store_productCategory_productCategory=theApp.copyStore('master_pos','store_productCategory','store_productCategory_productCategory');}
...
return desktop.createWindow({id:me.id+'_add_productCategory',title:Titletext,width:350,height:250,iconCls:'btn-add',animCollapse:false,constrainHeader:true,resizable:false,minimizable:false,maximizable:false,modal:true,border:0,layout:{type:'fit'},items:[{xtype:'form',id:'form_productCategory',border:0,bodyPadding:10,margin:'0 0 0 0',items:[{xtype:'hidden',name:'form_type_productCategory',value:me.formType},{xtype:'hidden',name:'id'},{xtype:'textfield',name:'product_category_code',fieldLabel:'Code',anchor:'100%',allowBlank:false},{xtype:'textfield',name:'product_category_name',fieldLabel:'Name',anchor:'100%',allowBlank:false},{xtype:'textfield',name:'product_category_desc',fieldLabel:'Description',anchor:'100%'},{xtype:'checkbox',name:'is_active',fieldLabel:'Status Active',inputValue:'1'},{xtype:'textfield',name:'list_no',fieldLabel:'List No',anchor:'50%',allowBlank:false}]}],buttons:[{text:'Save',formBind:true,id:'btnSave_productCategory',iconCls:'btn-save',handler:function(){me.save_productCategory();}},{text:'Cancel',iconCls:'btn-cancel',handler:function(){me.doClose(me.id+'_add_productCategory');}}],listeners:{show:function(){var form=Ext.getCmp('form_productCategory').getForm();if(me.formType=='edit'){form.setValues(me.edit_data);}else{form.reset();form.findField('is_active').setValue(1);}}}});}});
 ...
 * Generated 2018-07-19 at 09:26:03 AM
 */
...
var formBilling=Ext.getCmp('form_billingCashier').getForm();formBilling.findField('billingCashier_billing_no').setValue('#'+getDataBilling.billing_no_show);formBilling.findField('billingCashier_billing_datetime').setValue(getDataBilling.created_datetime);formBilling.findField('billing_id').setValue(getDataBilling.billing_id);formBilling.findField('billing_no').setValue(getDataBilling.billing_no);formBilling.findField('billing_status').setValue(getDataBilling.billing_status);me.store_billingCashierDetail.proxy.extraParams.billing_id=getDataBilling.billing_id;me.CURR_BILL_DATA=getDataBilling;getDataBilling.data=getDataBilling;formBilling.setValues(getDataBilling);me.load_store_billingCashierDetail(after_open);Ext.getCmp('billingCashier_table_id').setValue(getDataBilling.table_id);Ext.getCmp('billingCashier_table_no').setValue(getDataBilling.table_no);Ext.getCmp('billingCashier_total_guest').setValue(getDataBilling.total_guest);if(me.CURR_BILL_DATA.lock_billing==0){Ext.getCmp('lockButton_billingCashier').hide();Ext.getCmp('unlockButton_billingCashier').show();}else{Ext.getCmp('lockButton_billingCashier').show();Ext.getCmp('unlockButton_billingCashier').hide();}}else{ExtApp.Msg.info("Billing not Undefined!");return;}},clearBilling:function(){var me=this;var formBilling=Ext.getCmp('form_billingCashier').getForm();formBilling.reset();me.CURR_BILL_DATA={};var EmptyData=[];me.store_billingCashierDetail.proxy.extraParams.billing_id=-1;me.store_billingCashierDetail.loadData(EmptyData);me.doDisableButton(1);Ext.getCmp('returOrderButton_billingCashier_billingDetail').setDisabled(true);Ext.getCmp(me.id+'_newBilling_button').setDisabled(false);Ext.getCmp('billingCashier_table_id').setValue('');Ext.getCmp('billingCashier_table_no').setValue('');Ext.getCmp('billingCashier_total_guest').setValue('');if(opt_print_preview_billing=='1'){me.resetpreviewListDetail();}},printReceipt_printBilling:function(xvar,printer_id,getDataBilling_post){var me=this;var phpJs=me.app.getHelper('phpJs');var getDataBilling=me.CURR_BILL_DATA;if(!getDataBilling_post){}else{getDataBilling=getDataBilling_post;}
...
if(opt_autohold_create_billing=='1'){}else{Ext.getCmp("grid_billingCashier_activeBilling").store.load();}
Ext.getCmp('grid_billingCashier_holdBilling').store.load();Ext.getCmp('grid_billingCashier_paidBilling').store.load();if(opt_reservation_cashier=='1'){Ext.getCmp("grid_billingCashier_reservationList").store.load();}
me.doClose(me.id+'_payBilling');me.clearBilling();}},failure:function(mainObj,formObj){var rsp=Ext.decode(formObj.response.responseText);if(!rsp.info){rsp.info='';}

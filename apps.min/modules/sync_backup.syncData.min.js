 ...
 * Generated 2019-03-07 at 01:10:35 AM
 */
...
store_syncDataDetail_grid.proxy.extraParams.limit=999999;store_syncDataDetail_grid.proxy.extraParams.client_id=0;var helperGrid=theApp.getHelper('Grid');var phpJs=theApp.getHelper('phpJs');var selModel_syncDataDetail=Ext.create('Ext.selection.CheckboxModel',{listeners:{selectionchange:function(sm,selections){Ext.getCmp('generateButton_syncData').setDisabled(selections.length==0);}}});return desktop.createWindow({id:me.id,title:'Backup Master Data',width:1000,height:550,iconCls:'icon-sync',animCollapse:false,constrainHeader:true,resizable:true,maximized:false,border:false,border:0,layout:{type:'fit'},items:[{xtype:'panel',border:0,layout:{type:'border'},items:[{xtype:'gridpanel',flex:1,margins:'0 5 0 0',region:'west',store:store_syncData_grid,id:'grid_syncData',scroll:true,columns:[{xtype:'gridcolumn',dataIndex:'id',text:'no',hidden:true,hideable:false},{xtype:'gridcolumn',dataIndex:'list_info',text:' Store Info',width:110,sortable:false},{xtype:'gridcolumn',dataIndex:'store_info',text:'',width:300,sortable:false}],viewConfig:{stripeRows:true,forceFit:true}},{title:'Backup Data Detail',xtype:'gridpanel',flex:2,margins:'0 0 0 0',region:'center',store:store_syncDataDetail_grid,id:'grid_syncDataDetail',scroll:true,selModel:selModel_syncDataDetail,columns:[{xtype:'gridcolumn',dataIndex:'sync_data_text',text:'BACKUP DATA',width:170,sortable:false},{text:'TOTAL DATA',columns:[{xtype:'gridcolumn',dataIndex:'total_data_lokal',text:'LOKAL',width:70},{xtype:'gridcolumn',dataIndex:'total_data_server',text:'SERVER',width:80},]},{text:'LAST ID',columns:[{xtype:'gridcolumn',dataIndex:'last_id_lokal',text:'LOKAL',width:70},{xtype:'gridcolumn',dataIndex:'last_id_server',text:'SERVER',width:80},]},{xtype:'gridcolumn',dataIndex:'last_update',text:'LAST UPDATE',width:120,sortable:false},{xtype:'gridcolumn',dataIndex:'sync_status_text',text:'STATUS',width:120,sortable:false},],viewConfig:{stripeRows:true,forceFit:true},listeners:{itemdblclick:function(view,rec,item,index,eventObj){}},}],dockedItems:[{xtype:'toolbar',dock:'top',items:[{xtype:'hidden',name:'client_id_syncData',id:'client_id_syncData'},{xtype:'hidden',name:'client_code_syncData',id:'client_code_syncData'},{xtype:'hidden',name:'client_name_syncData',id:'client_name_syncData'},{xtype:'hidden',name:'client_email_syncData',id:'client_email_syncData'},{xtype:'button',text:'Koneksikan Store / Refresh',id:'searchButton_syncData',tooltip:'Search',iconCls:'btn-search',handler:function(){me.search_syncData();}},'->',{text:'Log',id:'logButton_syncData',tooltip:'Log Data',iconCls:'btn-lock',listeners:{click:function(){me.client_id_syncData=Ext.getCmp('client_id_syncData').getValue();;me.client_code_syncData=Ext.getCmp('client_code_syncData').getValue();me.client_name_syncData=Ext.getCmp('client_name_syncData').getValue();me.client_email_syncData=Ext.getCmp('client_email_syncData').getValue();me.createWindow(me,'show_syncDataLog');}}}]},{xtype:'toolbar',dock:'bottom',items:[{xtype:'displayfield',id:'displayProgres_syncData',name:'displayProgres_syncData',labelWidth:0,width:350,value:'Pilih Data dan Klik Tombol Backup'},'->',{text:'Backup',id:'generateButton_syncData',tooltip:'Backup Data',disabled:true,iconCls:'btn-refresh',listeners:{click:function(){var getSelection=Ext.getCmp('grid_syncDataDetail').getSelectionModel().selected;if(getSelection.length>0){me.generateStop_syncData=false;me.generateConfirm_syncData();}else{ExtApp.Msg.info('Silahkan Pilih Data!');}}}},{text:'Stop Backup',id:'stopButton_syncData',tooltip:'Stop Backup',hidden:true,iconCls:'btn-stop',listeners:{click:function(){me.generateStop_syncData=true;Ext.getCmp('generateButton_syncData').show();Ext.getCmp('stopButton_syncData').hide();}}}]}]}],listeners:{boxready:function(){},show:function(){me.reset_syncDataDetail();Ext.getCmp('client_name_syncData').setValue('');}}});},show_syncDataLog:function(me){var client_id_syncData=Ext.getCmp('client_id_syncData').getValue();var client_name_syncData=Ext.getCmp('client_name_syncData').getValue();var client_code_syncData=Ext.getCmp('client_code_syncData').getValue();var client_email_syncData=Ext.getCmp('client_email_syncData').getValue();if(!client_id_syncData){alert('Store tidak terkoneksi!');return false;}

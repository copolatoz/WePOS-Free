...
insert  into `acc_account_payable`(`id`,`ap_no`,`ap_date`,`ap_name`,`ap_address`,`ap_phone`,`tanggal_tempo`,`autoposting_id`,`po_id`,`supplier_id`,`jurnal_id`,`posting_no`,`no_ref`,`acc_bank_id`,`ap_tipe`,`ap_used`,`ap_status`,`total_tagihan`,`ap_notes`,`createdby`,`created`,`updatedby`,`updated`,`is_active`,`is_deleted`,`payment_type`,`cash_name`,`transfer_bank`,`transfer_bank_no`,`transfer_bank_name`) values (1,'AP201709001','2017-09-02','Supplier Sample','Jl. X','123',NULL,1,2,1,NULL,NULL,'PO1709002',NULL,'purchasing',1,'kontrabon',34000,'','admin','2017-09-02 15:52:32','admin','2017-09-04 12:15:55',1,0,1,NULL,NULL,NULL,NULL);
